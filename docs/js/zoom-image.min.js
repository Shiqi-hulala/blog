!function() {
    ...
    function m(e) {
        try {
            ...
            NodeList.prototype.isPrototypeOf(t) ? [].slice.call(e).filter(o) : E(e) ? [e].filter(o) : "string" == typeof e ? [].slice.call(document.querySelectorAll(e)).filter(o) : [])
        } catch (e) {
    ...
    function w(e, t) {
        ...
        return "function" == typeof window.CustomEvent ? new CustomEvent(e,o) : ((t = document.createEvent("CustomEvent")).initCustomEvent(e, o.bubbles, o.cancelable, o.detail),
        t)
    }
    function a(e, t) {
        function o(e) {
            function u() {
                var e = {
                  ...
                  , t = void 0
                  , o = void 0;
                v.container && (v.container instanceof Object ? (t = (e = l({}, e, v.container)).width - e.left - e.right - 2 * v.margin,
                o = e.height - e.top - e.bottom - 2 * v.margin) : (d = (i = (E(v.container) ? v.container : document.querySelector(v.container)).getBoundingClientRect()).width,
                a = i.height,
                r = i.left,
                m = i.top,
                e = l({}, e, {
                ...
                var n = z.zoomedHd || z.original
                  ...
                  , i = Math.min(i, t) / n
                  , d = Math.min(d, o) / a
                  , d = "scale(" + (d = Math.min(i, d)) + ") translate3d(" + ((t - n) / 2 - m + v.margin + e.left) / d + "px, " + ((o - a) / 2 - r + v.margin + e.top) / d + "px, 0)";
            ...
            return new i(function(e) {
                if (s && -1 === f.indexOf(s))
                    ...
                    function t() {
                        ...
                        z.original.dispatchEvent(w("medium-zoom:opened", {
                            detail: {
                                zoom: b
                            }
                        })),
                    ...
                    if (z.zoomed)
                        ...
                        z.original.dispatchEvent(w("medium-zoom:open", {
                            detail: {
                                zoom: b
                            }
                        })),
                        ...
                        v.template && (a = E(v.template) ? v.template : document.querySelector(v.template),
                        ...
                        z.original.getAttribute("data-zoom-src") ? (z.zoomedHd = z.zoomed.cloneNode(),
        ...
        var n = 1 < arguments.length && void 0 !== t ? t : {}
          ...
          , t = function() {
            for (var e = arguments, t = arguments.length, o = Array(t), n = 0; n < t; n++)
                o[n] = e[n];
          ...
          , p = function() {
            return new i(function(t) {
                ...
                !g && z.original ? (e = function e() {
                    ...
                    z.original.dispatchEvent(w("medium-zoom:closed", {
                        detail: {
                            zoom: b
                        }
                    })),
                ...
                z.original.dispatchEvent(w("medium-zoom:close", {
                    detail: {
                        zoom: b
                    }
                })),
                z.zoomed.addEventListener("transitionend", e)) : t(b)
            }
            )
        }
          , d = function(e) {
            e = (0 < arguments.length && void 0 !== e ? e : {}).target;
            return z.original ? p() : o({
                target: e
            })
        }
          , f = []
        ...
        document.addEventListener("scroll", function() {
            var e;
            !g && z.original && (e = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0,
        ...
        var b = {
            ...
            update: function(e) {
                var t = 0 < arguments.length && void 0 !== e ? e : {}
                  , e = t;
                return t.background && (y.style.background = t.background),
                t.container && t.container instanceof Object && (e.container = l({}, v.container, t.container)),
                t.template && (t = E(t.template) ? t.template : document.querySelector(t.template),
                e.template = t),
                v = l({}, v, e),
                f.forEach(function(e) {
                    e.dispatchEvent(w("medium-zoom:update", {
                        detail: {
                            zoom: b
                        }
                    }))
            ...
            detach: function() {
                for (var e = arguments, t = arguments.length, o = Array(t), n = 0; n < t; n++)
                    o[n] = e[n];
                z.zoomed && p();
                var i = 0 < o.length ? o.reduce(function(e, t) {
                    return [].concat(e, m(t))
                }, []) : f;
                return i.forEach(function(e) {
                    e.classList.remove("medium-zoom-image"),
                    e.dispatchEvent(w("medium-zoom:detach", {
                        detail: {
                            zoom: b
                        }
                    }))
    ...
    !function(e, t) {
        void 0 === t && (t = {});
        var o, n = t.insertAt;
        e && "undefined" != typeof document && (o = document.head || document.getElementsByTagName("head")[0],
