!function() {
    ...
    I.prototype.getFile = function(e, t) {
        ...
        n = e,
        r = a,
        e = (e = new RegExp("\\.(" + r.replace(/^\./, "") + "|html)$","g").test(n) ? n : /\/$/g.test(n) ? n + "README" + r : "" + n + r) === "/README" + a && i.homepage || e,
        e = O(e) ? e : N(o, e),
      ...
      , q = function(t) {
        ...
        e.prototype.onchange = function(n) {
            ...
            x("click", function(e) {
                ...
                t && "A" === t.tagName && !/_blank/.test(t.target) && (e.preventDefault(),
                t = t.href,
    ...
    var G, W = Object.hasOwnProperty, V = Object.setPrototypeOf, Y = Object.isFrozen, X = Object.getPrototypeOf, K = Object.getOwnPropertyDescriptor, Fe = Object.freeze, Q = Object.seal, J = Object.create, ee = "undefined" != typeof Reflect && Reflect, te = (te = ee.apply) || function(e, t, n) {
        return e.apply(t, n)
    }
    , Fe = Fe || function(e) {
        return e
    ...
    , Ce = re(Array.prototype.forEach), Le = re(Array.prototype.pop), ze = re(Array.prototype.push), Ne = re(String.prototype.toLowerCase), Me = re(String.prototype.match), De = re(String.prototype.replace), Pe = re(String.prototype.indexOf), Ie = re(String.prototype.trim), je = re(RegExp.prototype.test), He = (G = TypeError,
    function() {
    ...
    function qe(e, t) {
        ...
        for (var n = t.length; n--; ) {
            var r, i = t[n];
            "string" != typeof i || (r = Ne(i)) !== i && (Y(t) || (t[n] = r),
            i = r),
            e[i] = !0
        }
        return e
    ...
    var pt = function() {
      ...
      , ht = function(e, t) {
        if ("object" !== (void 0 === e ? "undefined" : ct(e)) || "function" != typeof e.createPolicy)
            return null;
        var n = null
    ...
    var ie, oe, ae = function t(e) {
        ...
        function O(e) {
            ge && ge === e || (e && "object" === (void 0 === e ? "undefined" : ct(e)) || (e = {}),
            e = Ue(e),
            P = "ALLOWED_TAGS"in e ? qe({}, e.ALLOWED_TAGS) : I,
            j = "ALLOWED_ATTR"in e ? qe({}, e.ALLOWED_ATTR) : H,
            le = "ADD_URI_SAFE_ATTR"in e ? qe(Ue(ce), e.ADD_URI_SAFE_ATTR) : ce,
            ae = "ADD_DATA_URI_TAGS"in e ? qe(Ue(se), e.ADD_DATA_URI_TAGS) : se,
            ...
            qe(j, Je),
            qe(j, tt)),
            !0 === $.svgFilters && (qe(P, We),
            qe(j, Je),
            qe(j, tt)),
            !0 === $.mathMl && (qe(P, Ye),
            qe(j, et),
            qe(j, tt))),
            e.ADD_TAGS && (P === I && (P = Ue(P)),
            qe(P, e.ADD_TAGS)),
            e.ADD_ATTR && (j === H && (j = Ue(j)),
            qe(j, e.ADD_ATTR)),
            e.ADD_URI_SAFE_ATTR && qe(le, e.ADD_URI_SAFE_ATTR),
            e.FORBID_CONTENTS && (ie === oe && (ie = Ue(ie)),
            qe(ie, e.FORBID_CONTENTS)),
            ne && (P["#text"] = !0),
        ...
        function Ee(e) {
            ...
            !((n = e)instanceof d || n instanceof f || "string" == typeof n.nodeName && "string" == typeof n.textContent && "function" == typeof n.removeChild && n.attributes instanceof h && "function" == typeof n.removeAttribute && "function" == typeof n.setAttribute && "string" == typeof n.namespaceURI && "function" == typeof n.insertBefore))
                return we(e),
                1;
            if (Me(e.nodeName, /[\u0080-\uFFFF]/))
                return we(e),
            ...
            !Ae(e.firstElementChild) && (!Ae(e.content) || !Ae(e.content.firstElementChild)) && je(/<[/\w]/g, e.innerHTML) && je(/<[/\w]/g, e.textContent))
                return we(e),
                1;
            if ("select" === n && je(/<template/i, e.innerHTML))
                return we(e),
                1;
            if (P[n] && !q[n])
                return e instanceof a && !function(e) {
                    var t = b(e);
                    t && t.tagName || (t = {
                        namespaceURI: he,
                        tagName: "template"
                    ...
                    var n = Ne(e.tagName)
                      , r = Ne(t.tagName);
                    return e.namespaceURI === pe ? t.namespaceURI === he ? "svg" === n : t.namespaceURI === ue ? "svg" === n && ("annotation-xml" === r || ve[r]) : Boolean(be[n]) : e.namespaceURI === ue ? t.namespaceURI === he ? "math" === n : t.namespaceURI === pe ? "math" === n && ye[r] : Boolean(ke[n]) : e.namespaceURI === he && (t.namespaceURI !== pe || ye[r]) && (t.namespaceURI !== ue || ve[r]) && (r = qe({}, ["title", "style", "font", "a", "script"]),
                    !ke[n] && (r[n] || !be[n]))
                }(e) || ("noscript" === n || "noembed" === n) && je(/<\/no(script|embed)/i, e.innerHTML) ? (we(e),
                1) : (W && 3 === e.nodeType && (t = e.textContent,
                t = De(t, F, " "),
                t = De(t, C, " "),
                e.textContent !== t && (ze(c.removed, {
                    element: e.cloneNode()
                }),
                e.textContent = t)),
        ...
        function Re(e, t, n) {
            ...
            if ((!Z || U[t] || !je(L, t)) && (!B || !je(z, t))) {
                if (!j[t] || U[t])
                    return !1;
                if (!le[t] && !je(D, De(n, M, "")) && ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== Pe(n, "data:") || !ae[e]) && (!G || je(N, De(n, M, ""))) && n)
                    return !1
            }
            return !0
        }
        ...
        function $e(e) {
            ...
            for (Te("beforeSanitizeShadowDOM", e, null); t = n.nextNode(); )
                ...
                Ee(t) || (t.content instanceof u && $e(t.content),
                Oe(t));
        ...
        return c.sanitize = function(e, t) {
            ...
            !re)
                if (e instanceof p)
                    1 === (t = (r = _e("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === t.nodeName || "HTML" === t.nodeName ? r = t : r.appendChild(t);
                else {
            ...
            for (var a = Se(re ? e : r); n = a.nextNode(); )
                3 === n.nodeType && n === i || Ee(n) || (n.content instanceof u && $e(n.content),
                Oe(n),
                i = n);
            if (i = null,
            re)
    ...
    function se(e) {
        ...
        ie || ((e = v("div")).classList.add("progress"),
        a(g, e),
        ie = e),
        t = i ? 80 < (t = parseInt(ie.style.width || 0, 10) + i) ? 80 : t : Math.floor(n / r * 100),
        ie.style.opacity = 1,
        ie.style.width = 95 <= t ? "100%" : t + "%",
        95 <= t && (clearTimeout(oe),
            ...
            then: function(t, n) {
                ...
                o("load", function(e) {
                    ...
                    400 <= e.status ? n(e) : (e = le[i] = {
                        content: e.response,
                        opt: {
                            updatedAt: a.getResponseHeader("last-modified")
                        }
                    },
                    t(e.content, e.opt))
                })
    ...
    function he() {
        ...
        window.pageYOffset >= e || t.classList.contains("hidden") ? S(g, "add", "sticky") : S(g, "remove", "sticky"))
    }
    function de(e, t, r, n) {
        var i = [];
        null != (t = d(t)) && (i = k(t, "a"));
        ...
        return i.sort(function(e, t) {
            ...
            0 !== a.indexOf(t) || o ? S(n, "remove", "active") : (o = e,
            S(n, "add", "active"))
        }),
    ...
    function we(e) {
        var t, n = y({
            ...
            relativePath: !1,
            topMargin: 0
        }, "function" == typeof window.$docsify ? window.$docsify(e) : window.$docsify), r = ke || [].slice.call(document.getElementsByTagName("script")).filter(function(e) {
    ...
    function Ee(e) {
        if (Ae) {
            ...
            !t || (n = xe[Re(e, t.getAttribute("data-id"))]) && n !== a && (a && a.classList.remove("active"),
            n.classList.add("active"),
            a = n,
            !_e && g.classList.contains("sticky") && (s = r.clientHeight,
      ...
      , Nt = function(n, e) {
        ...
        var r = {
            replace: function(e, t) {
                return t = (t = t.source || t).replace(St, "$1"),
                n = n.replace(e, t),
                r
            },
            getRegex: function() {
            ...
            if (e) {
                for (var t, n, r, i, o, a = e[0], s = e[2], l = 1 < s.length, c = {
                    ...
                    f !== h - 1) {
                        ...
                        this.options.pedantic ? r[1].length > d[1].length : r[1].length > d[0].length || 3 < r[1].length) {
                            u.splice(f, 2, u[f] + "\n" + u[f + 1]),
                            f--,
                            h--;
                            continue
        ...
        e.prototype.table = function(e) {
            ...
            if (e) {
                ...
                if (t.header.length === t.align.length) {
                    ...
                    for (n = t.cells.length,
                    r = 0; r < n; r++)
                        t.cells[r] = qt(t.cells[r].replace(/^ *\| *| *\| *$/g, ""), t.header.length);
                    return t
                }
            }
        }
        ...
        e.prototype.link = function(e) {
            ...
            if (t) {
                ...
                if (!this.options.pedantic && /^</.test(n)) {
                    ...
                    var r = Bt(t[2], "()");
                    -1 < r && (o = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + r,
    ...
    Nt.def = I(Nt.def).replace("label", Nt._label).replace("title", Nt._title).getRegex(),
    Nt.bullet = /(?:[*+-]|\d{1,9}[.)])/,
    Nt.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/,
    Nt.item = I(Nt.item, "gm").replace(/bull/g, Nt.bullet).getRegex(),
    Nt.listItemStart = I(/^( *)(bull)/).replace("bull", Nt.bullet).getRegex(),
    Nt.list = I(Nt.list).replace(/bull/g, Nt.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + Nt.def.source + ")").getRegex(),
    Nt._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
    Nt._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
    Nt.html = I(Nt.html, "i").replace("comment", Nt._comment).replace("tag", Nt._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
    Nt.paragraph = I(Nt._paragraph).replace("hr", Nt.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", Nt._tag).getRegex(),
    Nt.blockquote = I(Nt.blockquote).replace("paragraph", Nt.paragraph).getRegex(),
    Nt.normal = Dt({}, Nt),
    Nt.gfm = Dt({}, Nt.normal, {
    ...
    Nt.gfm.table = I(Nt.gfm.table).replace("hr", Nt.hr).replace("heading", " {0,3}#{1,6} ").replace("blockquote", " {0,3}>").replace("code", " {4}[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", Nt._tag).getRegex(),
    ...
    It.punctuation = I(It.punctuation).replace(/punctuation/g, It._punctuation).getRegex(),
    It._blockSkip = "\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>",
    It._overlapSkip = "__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*",
    It._comment = I(Nt._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
    It.em.start = I(It.em.start).replace(/punctuation/g, It._punctuation).getRegex(),
    It.em.middle = I(It.em.middle).replace(/punctuation/g, It._punctuation).replace(/overlapSkip/g, It._overlapSkip).getRegex(),
    It.em.endAst = I(It.em.endAst, "g").replace(/punctuation/g, It._punctuation).getRegex(),
    It.em.endUnd = I(It.em.endUnd, "g").replace(/punctuation/g, It._punctuation).getRegex(),
    It.strong.start = I(It.strong.start).replace(/punctuation/g, It._punctuation).getRegex(),
    It.strong.middle = I(It.strong.middle).replace(/punctuation/g, It._punctuation).replace(/overlapSkip/g, It._overlapSkip).getRegex(),
    It.strong.endAst = I(It.strong.endAst, "g").replace(/punctuation/g, It._punctuation).getRegex(),
    It.strong.endUnd = I(It.strong.endUnd, "g").replace(/punctuation/g, It._punctuation).getRegex(),
    ...
    It.autolink = I(It.autolink).replace("scheme", It._scheme).replace("email", It._email).getRegex(),
    It._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,
    It.tag = I(It.tag).replace("comment", It._comment).replace("attribute", It._attribute).getRegex(),
    It._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,
    It._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/,
    It._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
    It.link = I(It.link).replace("label", It._label).replace("href", It._href).replace("title", It._title).getRegex(),
    It.reflink = I(It.reflink).replace("label", It._label).getRegex(),
    It.reflinkSearch = I(It.reflinkSearch, "g").replace("reflink", It.reflink).replace("nolink", It.nolink).getRegex(),
    It.normal = Dt({}, It),
    ...
    It.gfm.url = I(It.gfm.url, "i").replace("email", It.gfm._extended_email).getRegex(),
    It.breaks = Dt({}, It.gfm, {
    ...
    var Jt = function() {
        function n(e) {
            ...
            this.options.pedantic ? (e.block = Vt.pedantic,
            e.inline = Yt.pedantic) : this.options.gfm && (e.block = Vt.gfm,
        ...
        n.prototype.blockTokens = function(e, t, n) {
            ...
            this.options.pedantic && (e = e.replace(/^ +$/gm, "")); e; )
                if (r = this.tokenizer.space(e))
                    ...
                    e = e.substring(r.raw.length),
                    r.type ? t.push(r) : ((a = t[t.length - 1]).raw += "\n" + r.raw,
                    a.text += "\n" + r.text);
            ...
            if (this.tokens.links) {
                ...
                if (0 < c.length)
                    for (; null != (o = this.tokenizer.rules.inline.reflinkSearch.exec(l)); )
                        c.includes(o[0].slice(o[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, o.index) + "[" + Xt("a", o[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
            }
            for (; null != (o = this.tokenizer.rules.inline.blockSkip.exec(l)); )
                l = l.slice(0, o.index) + "[" + Xt("a", o[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
            for (; e; )
                if (a || (s = ""),
                a = !1,
      ...
      , cn = function() {
        ...
        n.prototype.parse = function(e, t) {
            void 0 === t && (t = !0);
            for (var n, r, i, o, a, s, l, c, u, p, h, d, f, g, m, v = "", y = e.length, b = 0; b < y; b++)
                switch ((c = e[b]).type) {
                case "space":
                    continue;
                case "hr":
                ...
                case "list":
                    ...
                    n = 0; n < i; n++)
                        ...
                        g = d.task,
                        h = "",
                        d.task && (m = this.renderer.checkbox(f),
                        p ? 0 < d.tokens.length && "text" === d.tokens[0].type ? (d.tokens[0].text = m + " " + d.tokens[0].text,
                ...
                case "paragraph":
                    ...
                    continue;
                case "text":
                    for (l = c.tokens ? this.parseInline(c.tokens) : c.text; b + 1 < y && "text" === e[b + 1].type; )
    ...
    function fn(e, n, r) {
            ...
            return fn.walkTokens(i, function(n) {
                ...
                setTimeout(function() {
                    o(n.text, n.lang, function(e, t) {
                        return e ? a(e) : (null != t && t !== n.text && (n.text = t,
                        n.escaped = !0),
                        void (0 === --s && a()))
                    })
                }, 0))
        ...
        try {
            var t = Jt.lex(e, n);
            return n.walkTokens && fn.walkTokens(t, n.walkTokens),
            cn.parse(t, n)
        } catch (e) {
            if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
            n.silent)
                return "<p>An error occurred:</p><pre>" + hn(e.message + "", !0) + "</pre>";
            throw e
        }
    }
    fn.options = fn.setOptions = function(e) {
        return un(fn.defaults, e),
        dn(fn.defaults),
        fn
    }
    ,
    ...
    fn.use = function(o) {
        ...
        o.walkTokens && (t = fn.defaults.walkTokens,
    ...
    fn.parseInline = function(e, t) {
        ...
        try {
            ...
            return t.walkTokens && fn.walkTokens(n, t.walkTokens),
            cn.parseInline(n, t)
        } catch (e) {
            if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
            t.silent)
    ...
    function yn(e, r) {
        ...
        return e.forEach(function(e) {
            var t = e.level || 1
              , n = t - 1;
            r < t || (o[n] ? o[n].children = (o[n].children || []).concat(e) : i.push(e),
            o[t] = e)
        }),
        i
    }
    ...
    var Tn, En = ft(function(e) {
        var a, s, l, c, u, r, t, i = function(l) {
              ...
              , $ = {
                ...
                languages: {
                    ...
                    DFS: function e(t, n, r, i) {
                        ...
                        for (o in t) {
                            t.hasOwnProperty(o) && (n.call(t, o, t[o], r || o),
                            a = t[o],
                            "Object" !== (s = $.util.type(a)) || i[l(a)] ? "Array" !== s || i[l(a)] || (i[l(a)] = !0,
                            e(a, n, o, i)) : (i[l(a)] = !0,
                            e(a, n, null, i)))
                        }
                    }
                ...
                highlightElement: function(e, t, n) {
                    ...
                    if ($.hooks.run("before-sanity-check", a),
                    !a.code)
                        return $.hooks.run("complete", a),
                        void (n && n.call(a.element));
                    $.hooks.run("before-highlight", a),
                    a.grammar ? t && l.Worker ? ((t = new Worker($.filename)).onmessage = function(e) {
                        s(e.data)
                    }
                    ,
                ...
                highlight: function(e, t, n) {
                    ...
                    return $.hooks.run("before-tokenize", n),
                        ...
                        for (var s in r)
                            if (r.hasOwnProperty(s) && r[s]) {
                                ...
                                for (var c = 0; c < l.length; ++c) {
                                    ...
                                    for (var m = p.pattern || p, v = i.next, y = o; v !== n.tail && !(a && y >= a.reach); y += v.value.length,
                                    v = v.next) {
                                        var b = v.value;
            ...
            return n && ($.filename = n.src,
            n.hasAttribute("data-manual") && ($.manual = !0)),
            $.manual || ("loading" === (e = document.readyState) || "interactive" === e && n && n.defer ? document.addEventListener("DOMContentLoaded", r) : window.requestAnimationFrame ? window.requestAnimationFrame(r) : window.setTimeout(r, 16)),
            $
        ...
        a.hooks.add("before-sanity-check", function(e) {
            ...
            i.onreadystatechange = function() {
                4 == i.readyState && (i.status < 400 && i.responseText ? (o.setAttribute(l, "loaded"),
                t.textContent = i.responseText,
                a.highlightElement(t)) : (o.setAttribute(l, "failed"),
    ...
    Object.defineProperties(Tn.languages["markup-templating"] = {}, {
        ...
        tokenizePlaceholders: {
            value: function(c, u) {
                var p, h;
                c.language === u && c.tokenStack && (c.grammar = Tn.languages[u],
                p = 0,
                h = Object.keys(c.tokenStack),
                function e(t) {
                    for (var n = 0; n < t.length && !(p >= h.length); n++) {
                        var r, i, o, a, s, l = t[n];
                        "string" == typeof l || l.content && "string" == typeof l.content ? (i = h[p],
                        o = c.tokenStack[i],
                        r = "string" == typeof l ? l : l.content,
                        s = Rn(u, i),
                        -1 < (a = r.indexOf(s)) && (++p,
                        i = r.substring(0, a),
                        o = new Tn.Token(u,Tn.tokenize(o, c.grammar),"language-" + u,o),
    ...
    function On(i, e) {
        ...
        var a = r(e = i.markdown || {}) ? e(gn, t) : (gn.setOptions(y(e, {
            renderer: y(t, e.renderer)
        })),
        gn);
        this._marked = a,
        this.compile = function(n) {
            var r = !0
              , e = s(function(e) {
                ...
                }).replace(/:(\w+?):/gi, window.emojify || _n).replace(/__colon__/g, ":"),
                xn.clear(),
                t) : n
            })(n)
              , t = o.router.parse().file;
            return r ? o.toc = o.cacheTOC[t] : o.cacheTOC[t] = [].concat(o.toc),
            e
        }
    }
    var $n = {}
    ...
    On.prototype.compileEmbed = function(e, t) {
        ...
        if (t = o,
        i.include)
            return O(e) || (e = N(this.contentBase, F(this.router.getCurrentPath()), e)),
            i.type && (r = Fn[i.type]) ? (n = r.call(this, e, t)).type = i.type : (r = "code",
    ...
    On.prototype._matchNotCompileLink = function(e) {
        for (var t = this.config.noCompileLinks || [], n = 0; n < t.length; n++) {
            var r = t[n];
            if (($n[r] || ($n[r] = new RegExp("^" + r + "$"))).test(e))
                return e
        }
    }
    ,
    On.prototype._initRenderer = function() {
        var a, s, l, c, u, p, e = new gn.Renderer, t = this.linkTarget, n = this.linkRel, o = this.router, r = this.contentBase, h = this, i = {};
        ...
        n.link = function(e, t, n) {
            ...
            t = o,
            O(e) || c._matchNotCompileLink(e) || i.ignore ? (O(e) || "./" !== e.slice(0, 2) || (e = document.URL.replace(/\/(?!.*\/).*/, "/").replace("#/./", "") + e),
        ...
        r.image = function(e, t, n) {
            ...
            t && i.push('title="' + t + '"'),
            o.size && (t = (a = o.size.split("x"))[0],
            (a = a[1]) ? i.push('width="' + t + '" height="' + a + '"') : i.push('width="' + t + '"')),
    ...
    function Nn(e, r) {
        ...
        var u = [];
        !function(e, o) {
            var t, n = e.embedTokens, a = e.compile, s = (e.fetch,
            0), l = 1;
            if (!n.length)
                return o({});
            for (; t = n[s++]; ) {
            ...
            a.links = zn[i].links = c,
            r(a))
        })
    }
    function Mn(e, t, n) {
        var r, i, o, a;
        return t = "function" == typeof n ? n(t) : "string" == typeof n ? (o = [],
        a = 0,
        (r = n).replace(B, function(t, e, n) {
            o.push(r.substring(a, n - 1)),
            a = n += t.length + 1,
            o.push(i && i[t] || function(e) {
    ...
    function Dn(e) {
        ...
        "Vue"in window)
            for (var o = 0, a = k(".markdown-section > *").filter(t); o < a.length; o += 1) {
                var s = a[o];
                2 === i ? s.__vue__.$destroy() : 3 === i && s.__vue_app__.unmount()
            }
        if (this._renderTo(r, e),
        n.loadSidebar || this._renderSidebar(),
        (n.executeScript || "Vue"in window && !1 !== n.executeScript) && (!(e = k(".markdown-section>script").filter(function(e) {
        ...
        "Vue"in window) {
            ...
            !Cn && n.vueGlobalOptions && "function" == typeof n.vueGlobalOptions.data && (Cn = n.vueGlobalOptions.data()),
            ...
            c = /<[^>/]+\s([@:]|v-)[\w-:.[\]]+[=>\s]/,
            u.push.apply(u, k(".markdown-section > *").filter(function(n) {
    ...
    function Pn(t, n, r, i, o, e) {
        t = e ? t : t.replace(/\/$/, ""),
        (t = F(t)) && ce(o.router.getFile(t + r) + n, !1, o.config.requestHeaders).then(i, function(e) {
            return Pn(t, n, r, i, o)
        })
    }
    ...
    var jn, Hn, qn = function(e) {
        ...
        ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype.initPlugin = function() {
            var t = this;
    ...
    function(e) {
        ...
        return e && (t.__proto__ = e),
        ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype._loadSideAndNav = function(e, t, n, r) {
            var i = this;
            return function() {
                if (!n)
                    return r();
        ...
        t.prototype._fetch = function(n) {
            ...
            p(l) ? (history.replaceState(null, "", "#"),
            this.router.normalize()) : (i = R(s, ["id"]),
        ...
        t.prototype._fetchCover = function() {
            ...
            if (n) {
                ...
                return a ? (a = this.router.getFile(o + a),
        ...
        t.prototype.initFetch = function() {
            ...
            this.rendered ? (e = de(this.router, ".sidebar-nav", !0, !0),
        ...
        return e && (t.__proto__ = e),
        ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype.$resetEvents = function(e) {
            var t = this
              , n = this.config.auto2top;
            "history" !== e && (t.route.query.id && Oe(t.route.path, t.route.query.id),
        ...
        t.prototype.initEvent = function() {
            ...
            this.router,
            null != (e = d(e)) && (x(e, "click", function(e) {
                e.stopPropagation(),
                t()
            }),
        ...
        return e && (t.__proto__ = e),
        ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype._renderTo = function(e, t, n) {
            e = d(e);
        ...
        t.prototype._bindEventOnRendered = function(e) {
            ...
            !function(e) {
                ...
                for (var r, i = 0, o = n.length; i < o; i += 1) {
                    ...
                    c && ("/" !== (a = c.getAttribute("href")) && (c = (s = e.parse(a)).query.id,
                    s = s.path,
                    c && (a = Re(s, c))),
                    a && (xe[decodeURIComponent(a)] = l))
                }
                h || (r = $(e.getCurrentPath()),
                _("scroll", function() {
                    return Ee(r)
                }),
                x("scroll", function() {
            ...
            n && e && ((n = (t = d("#main")).children[0]) && "H1" !== n.tagName && w(t, v("div", this.compiler.header(e.innerText, 1)).children[0]))
        }
        ,
        ...
        t.prototype._renderMain = function(r, i, o) {
            ...
            if (void 0 === i && (i = {}),
            !r)
                return Dn.call(this, r);
            this.callHook("beforeEach", r, function(e) {
                function t() {
                    i.updatedAt && (n = Mn(n, i.updatedAt, a.config.formatUpdated)),
                    a.callHook("afterEach", n, function(e) {
                        return Dn.call(a, e)
                    })
                }
                var n;
                a.isHTML ? (n = a.result = r,
                t(),
                o()) : Nn({
                    compiler: a.compiler,
                    raw: e
        ...
        t.prototype.initRender = function() {
            ...
            i ? (/\/\//.test(i) || (i = "https://github.com/" + i),
            '<a href="' + (i = i.replace(/^git\+/, "")) + '" target="' + (a = a || "_blank") + '" class="github-corner" aria-label="View source on Github"><svg viewBox="0 0 250 250" aria-hidden="true"><path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path><path d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" fill="currentColor" style="transform-origin: 130px 106px;" class="octo-arm"></path><path d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor" class="octo-body"></path></svg></a>') : "")),
            e.coverpage && (c += (r = ", 100%, 85%",
            '<section class="cover show" style="background: ' + ("linear-gradient(to left bottom, hsl(" + Math.floor(255 * Math.random()) + r + ") 0%,hsl(" + Math.floor(255 * Math.random()) + r + ") 100%)") + '"><div class="mask"></div><div class="cover-main">\x3c!--cover--\x3e</div></section>')),
            e.logo && (r = /^data:image/.test(e.logo),
            t = /(?:http[s]?:)?\/\//.test(e.logo),
            n = /^\./.test(e.logo),
            r || t || n || (e.logo = N(this.router.getBasePath(), e.logo))),
            c += (n = (t = e).name ? t.name : "",
            "<main>" + ('<button class="sidebar-toggle" aria-label="Menu"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><aside class="sidebar">' + (t.name ? '<h1 class="app-name"><a class="app-name-link" data-nosearch>' + (t.logo ? '<img alt="' + n + '" src=' + t.logo + ">" : n) + "</a></h1>" : "") + '<div class="sidebar-nav">\x3c!--sidebar--\x3e</div></aside>') + '<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'),
            this._renderTo(l, c, !0)) : this.rendered = !0,
            e.mergeNavbar && h ? u = b(".sidebar") : (s.classList.add("app-nav"),
            e.repo || s.classList.add("no-badge")),
            e.loadNavbar && w(u, s),
            e.themeColor && (f.head.appendChild(v("div", "<style>:root{--theme-color: " + e.themeColor + ";}</style>").firstElementChild),
            o = e.themeColor,
        ...
        ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.updateRender = function() {
        ...
        e.prototype.initRouter = function() {
            var t = this
              , e = this.config
              , e = new ("history" === (e.routerMode || "hash") && i ? q : H)(e);
            this.router = e,
            this.updateRender(),
            U = this.route,
            e.onchange(function(e) {
                t.updateRender(),
                t._updateRender(),
                U.path !== t.route.path ? (t.$fetch(u, t.$resetEvents.bind(t, e.source)),
                U = t.route) : t.$resetEvents(e.source)
            })
        }
        ,
        e
        ...
        return e && (t.__proto__ = e),
        ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype.initLifecycle = function() {
            var n = this;
            this._hooks = {},
            this._lifecycle = {},
